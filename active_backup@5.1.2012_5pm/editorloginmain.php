...
$selected_value = $_REQUEST['mydropdown'];
		if($selected_value != ""){
			header("Location:editors/editor1/editor1login.php?topic_id={$selected_value}");
		}
		else{
			echo "pls select the relevant topic";
		}
}
?>
...
<div id="pamwrapper">
	...
	<div id="left">
	  <form name="myform" action="editorloginmain.php" method="post">
		<div align="center"> <center><p> <b>Please Select the relevant topic to view </b><br>
